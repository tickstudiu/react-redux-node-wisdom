...
import {CardHeaderDrugText} from './text/CardHeaderDrug.text';
import * as tools from "../../../utils";

export default class CardHeaderDrug extends React.Component {
    render() {
        const staticText = tools.checkLanguage(CardHeaderDrugText);
        return (
