...
export default class CardActivities extends React.Component{
    render(){
        const {title, body, image, activityRouteById, id} = this.props;
        return (
            <Card className="mb-3 cursor-pointer hover-shadow" onClick={() => activityRouteById(id)}>
